# SmartBrain_3000 documentation

These pages are the user guide. They're the **single source** for both the public
docs (here on GitHub) and the in-app **Help** page (`/help`) — the app renders
this same Markdown at build time.
...
7. [Remote access](07-remote-access.md) — reach your assistant from your phone, on Wi-Fi or cellular, by pairing a device (WebRTC, no port-forward, off by default).
8. [Design limits](08-design-limits.md) — the intentional single-user / local-first scope choices and why we made them.
