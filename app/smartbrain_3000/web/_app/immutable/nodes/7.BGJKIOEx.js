import{b as k,a as S,f as D}from"../chunks/C0ItKQf8.js";import{ba as O,am as u,a$ as T,ag as h,ak as A,J as P,aO as q,al as C,c as x,ah as _,ao as L,l as B,Z as N,s as E,r as U,aL as K,be as G,aI as M,ad as o,V as w,b3 as I,aR as y,aX as W,bd as H,b6 as Y}from"../chunks/DRDg0sf4.js";import{s as F}from"../chunks/fYgJYrVp.js";import{e as z}from"../chunks/BP9iacjq.js";import{s as R}from"../chunks/shdympQJ.js";import{s as j}from"../chunks/BvpNrMdj.js";import{b as Q}from"../chunks/C51NAVH_.js";import{p as J}from"../chunks/QD9usWZH.js";function V(p,m,l=!1,s=!1,i=!1,g=!1){var d=p,r="";if(l){var n=p;u&&(d=T(h(n)))}O(()=>{var t=P;if(r===(r=m()??"")){u&&A();return}if(l&&!u){t.nodes=null,n.innerHTML=r,r!==""&&k(h(n),n.lastChild);return}if(t.nodes!==null&&(q(t.nodes.start,t.nodes.end),t.nodes=null),r!==""){if(u){C.data;for(var e=A(),a=e;e!==null&&(e.nodeType!==x||e.data!=="");)a=e,e=_(e);if(e===null)throw L(),B;k(C,a),d=T(e);return}var f=s?E:i?U:void 0,v=N(s?"svg":i?"math":"template",f);v.innerHTML=r;var c=s||i?v:v.content;if(k(h(c),c.lastChild),s||i)for(;h(c);)d.before(h(c));else d.before(c)}})}const b=[{slug:"getting-started",title:"Getting started",html:`<h1>Getting started</h1>
...
`}];var X=D("<a> </a>"),$=D('<div class="help svelte-1vby5nc"><nav class="help-nav svelte-1vby5nc" aria-label="Help sections"><h2 class="svelte-1vby5nc">Help</h2> <!></nav> <article class="help-body card svelte-1vby5nc"></article></div>');function ie(p,m){K(m,!0);const l=H(()=>b.find(n=>n.slug===J.url.hash.replace(/^#/,""))??b[0]);let s=Y(void 0);G(()=>{if(o(l),typeof window>"u"||!o(s))return;const n=window.matchMedia("(prefers-reduced-motion: reduce)"),t=()=>{for(const e of o(s).querySelectorAll("img")){const a=e.getAttribute("src")??"";n.matches&&a.endsWith(".gif")?(e.dataset.gif=a,e.setAttribute("src",a.replace(/\.gif$/,".poster.png"))):!n.matches&&e.dataset.gif&&(e.setAttribute("src",e.dataset.gif),delete e.dataset.gif)}};return t(),n.addEventListener("change",t),()=>n.removeEventListener("change",t)});var i=$(),g=w(i),d=I(w(g),2);z(d,17,()=>b,n=>n.slug,(n,t)=>{var e=X();let a;var f=w(e,!0);y(e),O(()=>{a=j(e,1,"help-link svelte-1vby5nc",null,a,{active:o(t).slug===o(l).slug}),R(e,"aria-current",o(t).slug===o(l).slug?"page":void 0),R(e,"href",`#${o(t).slug}`),F(f,o(t).title)}),S(n,e)}),y(g);var r=I(g,2);V(r,()=>o(l).html,!0),y(r),Q(r,n=>W(s,n),()=>o(s)),y(i),S(p,i),M()}export{ie as component};
