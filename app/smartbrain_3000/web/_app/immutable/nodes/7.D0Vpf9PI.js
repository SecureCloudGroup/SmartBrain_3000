import{G as e,H as t,L as n,O as r,Q as i,T as a,V as o,X as s,Y as c,b as l,c as u,ct as d,j as f,k as p,m,nt as h,q as g,rt as _,w as v}from"../chunks/CXkL0Yf_.js";import"../chunks/xihTtKlq.js";import{t as y}from"../chunks/Cc_qSaWX.js";var b=[{slug:`getting-started`,title:`Getting started`,html:`<h1 id="getting-started">Getting started</h1>
...
`}],x=f(`<a> </a>`),S=f(`<div class="help svelte-1vby5nc"><nav class="help-nav svelte-1vby5nc" aria-label="Help sections"><h2 class="svelte-1vby5nc">Help</h2> <!></nav> <article class="help-body card svelte-1vby5nc"></article></div>`);function C(f,C){_(C,!0);let w=i(()=>y.url.hash.replace(/^#/,``).split(`__`)),T=i(()=>b.find(e=>e.slug===n(w)[0])??b[0]),E=i(()=>n(w)[1]),D=s(void 0);t(()=>{if(n(T),typeof window>`u`||!n(D))return;let e=window.matchMedia(`(prefers-reduced-motion: reduce)`),t=()=>{for(let t of n(D).querySelectorAll(`img`)){let n=t.getAttribute(`src`)??``;e.matches&&n.endsWith(`.gif`)?(t.dataset.gif=n,t.setAttribute(`src`,n.replace(/\.gif$/,`.poster.png`))):!e.matches&&t.dataset.gif&&(t.setAttribute(`src`,t.dataset.gif),delete t.dataset.gif)}};return t(),e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)}),t(()=>{n(T);let e=n(E);typeof window>`u`||!n(D)||!e||!/^[\w-]+$/.test(e)||n(D).querySelector(`[id="${e}"]`)?.scrollIntoView()});var O=S(),k=e(O);a(g(e(k),2),17,()=>b,e=>e.slug,(t,i)=>{var a=x();let s;var c=e(a,!0);d(a),o(()=>{s=l(a,1,`help-link svelte-1vby5nc`,null,s,{active:n(i).slug===n(T).slug}),m(a,`aria-current`,n(i).slug===n(T).slug?`page`:void 0),m(a,`href`,`#${n(i).slug}`),r(c,n(i).title)}),p(t,a)}),d(k);var A=g(k,2);v(A,()=>n(T).html,!0),d(A),u(A,e=>c(D,e),()=>n(D)),d(O),p(f,O),h()}export{C as component};