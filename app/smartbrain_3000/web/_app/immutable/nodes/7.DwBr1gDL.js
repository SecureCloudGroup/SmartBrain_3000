import{A as e,B as t,C as n,D as r,I as i,J as a,K as o,O as s,V as c,W as l,Y as u,Z as d,b as f,c as p,m,nt as h,st as g,tt as _,w as v}from"../chunks/DBeuis-e.js";import"../chunks/xihTtKlq.js";import{t as y}from"../chunks/DYraL9xM.js";var b=[{slug:`getting-started`,title:`Getting started`,html:`<h1 id="getting-started">Getting started</h1>
...
<p><strong>MLX-only stack (no Ollama):</strong> chat servers like oMLX serve encoder embedders only
(BGE-class) and refuse decoder embedding models such as Qwen3-Embedding. For those, run
the bundled <strong>MLX embeddings server</strong> (<code>tools/mlx_embed_server/install.sh</code> — a tiny
login service on port 8899 serving <code>Qwen3-Embedding-0.6B</code> with correct pooling), connect
it under Settings → Local models → <strong>MLX embeddings</strong>, then route Settings → Model
routing → Embedding → <code>mlxe/qwen3-embedding-0.6b</code> and <strong>Reindex</strong>.</p>
