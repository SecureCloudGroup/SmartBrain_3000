import{b as k,a as S,f as D}from"../chunks/CmU3Iq60.js";import{t as P,j as u,K as T,aa as h,G as A,B as q,av as O,M as C,N as x,a9 as _,aw as L,ax as B,ay as N,az as E,aA as K,p as U,ao as G,a as M,s as I,c as w,g as o,r as y,d as W,u as H,b as Y}from"../chunks/CgJqcz4Q.js";import{s as F}from"../chunks/BADY5oOC.js";import{e as z}from"../chunks/Drmrk0ox.js";import{s as R}from"../chunks/BEOSnift.js";import{s as j}from"../chunks/D_3rPwoa.js";import{b as Q}from"../chunks/JAy6G-Bw.js";import{p as J}from"../chunks/DFWMguF1.js";function V(p,m,l=!1,s=!1,i=!1,g=!1){var d=p,r="";if(l){var n=p;u&&(d=T(h(n)))}P(()=>{var t=q;if(r===(r=m()??"")){u&&A();return}if(l&&!u){t.nodes=null,n.innerHTML=r,r!==""&&k(h(n),n.lastChild);return}if(t.nodes!==null&&(O(t.nodes.start,t.nodes.end),t.nodes=null),r!==""){if(u){C.data;for(var e=A(),a=e;e!==null&&(e.nodeType!==x||e.data!=="");)a=e,e=_(e);if(e===null)throw L(),B;k(C,a),d=T(e);return}var f=s?E:i?K:void 0,v=N(s?"svg":i?"math":"template",f);v.innerHTML=r;var c=s||i?v:v.content;if(k(h(c),c.lastChild),s||i)for(;h(c);)d.before(h(c));else d.before(c)}})}const b=[{slug:"getting-started",title:"Getting started",html:`<h1>Getting started</h1>
...
<h2>Self-hosting the signaling node (advanced)</h2>
...
`}];var X=D("<a> </a>"),$=D('<div class="help svelte-1vby5nc"><nav class="help-nav svelte-1vby5nc" aria-label="Help sections"><h2 class="svelte-1vby5nc">Help</h2> <!></nav> <article class="help-body card svelte-1vby5nc"></article></div>');function ie(p,m){U(m,!0);const l=H(()=>b.find(n=>n.slug===J.url.hash.replace(/^#/,""))??b[0]);let s=Y(void 0);G(()=>{if(o(l),typeof window>"u"||!o(s))return;const n=window.matchMedia("(prefers-reduced-motion: reduce)"),t=()=>{for(const e of o(s).querySelectorAll("img")){const a=e.getAttribute("src")??"";n.matches&&a.endsWith(".gif")?(e.dataset.gif=a,e.setAttribute("src",a.replace(/\.gif$/,".poster.png"))):!n.matches&&e.dataset.gif&&(e.setAttribute("src",e.dataset.gif),delete e.dataset.gif)}};return t(),n.addEventListener("change",t),()=>n.removeEventListener("change",t)});var i=$(),g=w(i),d=I(w(g),2);z(d,17,()=>b,n=>n.slug,(n,t)=>{var e=X();let a;var f=w(e,!0);y(e),P(()=>{a=j(e,1,"help-link svelte-1vby5nc",null,a,{active:o(t).slug===o(l).slug}),R(e,"aria-current",o(t).slug===o(l).slug?"page":void 0),R(e,"href",`#${o(t).slug}`),F(f,o(t).title)}),S(n,e)}),y(g);var r=I(g,2);V(r,()=>o(l).html,!0),y(r),Q(r,n=>W(s,n),()=>o(s)),y(i),S(p,i),M()}export{ie as component};
