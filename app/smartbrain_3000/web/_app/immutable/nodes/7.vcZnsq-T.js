import{A as e,B as t,C as n,D as r,I as i,J as a,K as o,O as s,V as c,W as l,Y as u,Z as d,b as f,c as p,m,nt as h,ot as g,tt as _,w as v}from"../chunks/BKwOMm0i.js";import"../chunks/xihTtKlq.js";import{t as y}from"../chunks/BLN7PqIX.js";var b=[{slug:`getting-started`,title:`Getting started`,html:`<h1 id="getting-started">Getting started</h1>
...
and there is <strong>nothing to set up</strong>: dictation is built in, on every OS.</p>
<ul>
<li><strong>Built in (the default)</strong> — SmartBrain transcribes on your machine with
<a href="https://github.com/usefulsensors/moonshine">Moonshine</a>, a fast on-device
speech-to-text model. Its model files (~236 MB, integrity-checked) download once,
in the background, starting the moment the app launches — <strong>watch the progress
right on the mic button</strong>, or on <strong>Settings → Status</strong>. Until it&#39;s ready the mic
shows a live percent instead of pretending; after that, dictation is instant and
fully offline. English only, for now.</li>
...
<p>Chat can listen and talk — with <strong>nothing to set up</strong>: dictation is built in on every
OS (see <a href="#models__voice-dictation-and-spoken-replies">Voice</a> for how, and for the
optional own-server upgrade). A <strong>microphone button</strong> sits in the message box: tap, speak, tap
