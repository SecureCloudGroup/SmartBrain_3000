...
`},{slug:`models`,title:`Connect a model`,headings:[{id:`cloud-providers-your-api-keys`,text:`Cloud providers (your API keys)`},{id:`local-models-yours-on-this-machine-or-another-one-you-own`,text:`Local models (yours — on this machine or another one you own)`},{id:`claude-code-your-claude-account-sends-chats-to-anthropic`,text:`Claude Code (your Claude account — sends chats to Anthropic)`},{id:`choosing-a-model-in-chat`,text:`Choosing a model in Chat`},{id:`which-model-does-what-model-routing`,text:`Which model does what (Model routing)`},{id:`embeddings-for-knowledge-search`,text:`Embeddings (for Knowledge search)`},{id:`voice-dictation-and-spoken-replies`,text:`Voice (dictation and spoken replies)`},{id:`next`,text:`Next`}],html:`<h1 id="connect-a-model">Connect a model</h1>
...
<h2 id="claude-code-your-claude-account-sends-chats-to-anthropic">Claude Code (your Claude account — sends chats to Anthropic)</h2>
...
by tests in SmartBrain&#39;s suite, not just promised here.)</p>
...
still goes to Anthropic. See <a href="#models__claude-code-your-claude-account--sends-chats-to-anthropic">Connect a model</a>.</li>
