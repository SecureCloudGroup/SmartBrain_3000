...
<p>A dashboard of things you asked to watch. You describe what you want to see in
Chat — <em>&quot;show me AAPL every 5 minutes&quot;</em>, <em>&quot;a card with my open tasks by due
date&quot;</em> — and the assistant designs a card for it: where the data comes from, how
it&#39;s processed, and how it&#39;s laid out. The engine then keeps it fresh on its own
schedule.</p>
<p>How a card comes to life:</p>
<ol>
<li><strong>You pick the source.</strong> The assistant suggests candidates — first from a
small <strong>vetted catalog</strong> of free, keyless public APIs, and it says so; a
...
you again.</li>
<li><strong>Preview first.</strong> The assistant shows the card with sample data so you can
approve the look (&quot;make the total bigger&quot; works — it&#39;s a conversation).</li>
<li><strong>Commissioning.</strong> After you approve, the system runs the real pipeline and
shows you the first live result — you confirm it&#39;s the <em>right</em> data, and one
more clean run at cadence proves it&#39;s stable. Only then is the card live.</li>
...
step, or a card whose source <em>is</em> a model instruction — wears an
<strong>Interpreted</strong> chip, so you can always tell a model&#39;s reading from pure
arithmetic. Cards with a language-model step refresh at most every 5 minutes.</p>
...
<p>Each card offers <strong>Run now</strong>, <strong>Pause</strong>, and <strong>Delete</strong>; drafts are marked
