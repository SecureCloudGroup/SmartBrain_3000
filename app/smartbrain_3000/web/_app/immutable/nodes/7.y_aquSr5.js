import{$ as e,A as t,B as n,C as r,D as i,F as a,J as o,K as s,O as c,W as l,X as u,Y as d,at as f,b as p,c as m,et as h,m as g,w as _,z as v}from"../chunks/DRLcFEIE.js";import"../chunks/xihTtKlq.js";import{t as y}from"../chunks/B9eTyvoU.js";var b=[{slug:`getting-started`,title:`Getting started`,html:`<h1 id="getting-started">Getting started</h1>
...
`}],x=t(`<a> </a>`),S=t(`<div class="help svelte-1vby5nc"><nav class="help-nav svelte-1vby5nc" aria-label="Help sections"><h2 class="svelte-1vby5nc">Help</h2> <!></nav> <article class="help-body card svelte-1vby5nc"></article></div>`);function C(t,C){h(C,!0);let w=u(()=>y.url.hash.replace(/^#/,``).split(`__`)),T=u(()=>b.find(e=>e.slug===a(w)[0])??b[0]),E=u(()=>a(w)[1]),D=d(void 0);n(()=>{if(a(T),typeof window>`u`||!a(D))return;let e=window.matchMedia(`(prefers-reduced-motion: reduce)`),t=()=>{for(let t of a(D).querySelectorAll(`img`)){let n=t.getAttribute(`src`)??``;e.matches&&n.endsWith(`.gif`)?(t.dataset.gif=n,t.setAttribute(`src`,n.replace(/\.gif$/,`.poster.png`))):!e.matches&&t.dataset.gif&&(t.setAttribute(`src`,t.dataset.gif),delete t.dataset.gif)}};return t(),e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)}),n(()=>{a(T);let e=a(E);typeof window>`u`||!a(D)||!e||!/^[\w-]+$/.test(e)||a(D).querySelector(`[id="${e}"]`)?.scrollIntoView()});var O=S(),k=l(O);_(s(l(k),2),17,()=>b,e=>e.slug,(e,t)=>{var n=x();let r;var o=l(n,!0);f(n),v(()=>{r=p(n,1,`help-link svelte-1vby5nc`,null,r,{active:a(t).slug===a(T).slug}),g(n,`aria-current`,a(t).slug===a(T).slug?`page`:void 0),g(n,`href`,`#${a(t).slug}`),i(o,a(t).title)}),c(e,n)}),f(k);var A=s(k,2);r(A,()=>a(T).html,!0),f(A),m(A,e=>o(D,e),()=>a(D)),f(O),c(t,O),e()}export{C as component};