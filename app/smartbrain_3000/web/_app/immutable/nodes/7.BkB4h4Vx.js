import{C as e,E as t,H as n,J as r,K as i,L as a,N as o,O as s,Q as c,R as l,S as u,T as d,W as f,Z as p,c as m,p as h,q as g,rt as _,y as v}from"../chunks/DWX88Ymn.js";import"../chunks/xihTtKlq.js";import{t as y}from"../chunks/B56iCB2A.js";var b=[{slug:`getting-started`,title:`Getting started`,html:`<h1 id="getting-started">Getting started</h1>
...
`}],x=s(`<a> </a>`),S=s(`<div class="help svelte-1vby5nc"><nav class="help-nav svelte-1vby5nc" aria-label="Help sections"><h2 class="svelte-1vby5nc">Help</h2> <!></nav> <article class="help-body card svelte-1vby5nc"></article></div>`);function C(s,C){c(C,!0);let w=r(()=>y.url.hash.replace(/^#/,``).split(`__`)),T=r(()=>b.find(e=>e.slug===o(w)[0])??b[0]),E=r(()=>o(w)[1]),D=g(void 0);l(()=>{if(o(T),typeof window>`u`||!o(D))return;let e=window.matchMedia(`(prefers-reduced-motion: reduce)`),t=()=>{for(let t of o(D).querySelectorAll(`img`)){let n=t.getAttribute(`src`)??``;e.matches&&n.endsWith(`.gif`)?(t.dataset.gif=n,t.setAttribute(`src`,n.replace(/\.gif$/,`.poster.png`))):!e.matches&&t.dataset.gif&&(t.setAttribute(`src`,t.dataset.gif),delete t.dataset.gif)}};return t(),e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)}),l(()=>{o(T);let e=o(E);typeof window>`u`||!o(D)||!e||!/^[\w-]+$/.test(e)||o(D).querySelector(`[id="${e}"]`)?.scrollIntoView()});var O=S(),k=n(O);e(f(n(k),2),17,()=>b,e=>e.slug,(e,r)=>{var i=x();let s;var c=n(i,!0);_(i),a(()=>{s=v(i,1,`help-link svelte-1vby5nc`,null,s,{active:o(r).slug===o(T).slug}),h(i,`aria-current`,o(r).slug===o(T).slug?`page`:void 0),h(i,`href`,`#${o(r).slug}`),d(c,o(r).title)}),t(e,i)}),_(k);var A=f(k,2);u(A,()=>o(T).html,!0),_(A),m(A,e=>i(D,e),()=>o(D)),_(O),t(s,O),p()}export{C as component};