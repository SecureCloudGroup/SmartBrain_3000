import{b as f,a as b,f as I}from"../chunks/CD5zTj3j.js";import{b9 as O,al as g,a_ as S,af as c,aj as T,J as D,aN as x,ak as A,c as P,ag as _,an as N,l as E,Z as B,s as L,r as K,aK as M,aH as U,V as k,b2 as C,aQ as u,ac as i,bc as G}from"../chunks/DSyNeLMP.js";import{s as W}from"../chunks/CVD7czyh.js";import{e as H}from"../chunks/blDM2rQR.js";import{s as R}from"../chunks/CxL3veOo.js";import{s as Y}from"../chunks/CtIjk2rY.js";import{p as F}from"../chunks/DJbGIehF.js";function z(d,y,l=!1,r=!1,a=!1,w=!1){var s=d,e="";if(l){var o=d;g&&(s=S(c(o)))}O(()=>{var n=D;if(e===(e=y()??"")){g&&T();return}if(l&&!g){n.nodes=null,o.innerHTML=e,e!==""&&f(c(o),o.lastChild);return}if(n.nodes!==null&&(x(n.nodes.start,n.nodes.end),n.nodes=null),e!==""){if(g){A.data;for(var t=T(),p=t;t!==null&&(t.nodeType!==P||t.data!=="");)p=t,t=_(t);if(t===null)throw N(),E;f(A,p),s=S(t);return}var q=r?L:a?K:void 0,m=B(r?"svg":a?"math":"template",q);m.innerHTML=e;var h=r||a?m:m.content;if(f(c(h),h.lastChild),r||a)for(;c(h);)s.before(c(h));else s.before(h)}})}const v=[{slug:"getting-started",title:"Getting started",html:`<h1>Getting started</h1>
...
<li><p><strong>Send your first message.</strong> Ask it anything — e.g. <em>&quot;What can you help me with?&quot;</em></p>
</li>
<li><p><strong>Add something to Knowledge.</strong> Open <strong>Knowledge</strong>, add a note or drop in a PDF,
then <strong>Reindex</strong> so semantic search can find it. Now ask Chat about it.</p>
</li>
<li><p><strong>Watch the approval flow.</strong> Ask the assistant to <em>&quot;add a task to call the dentist
tomorrow.&quot;</em> Because creating a task changes data, it <strong>parks for your approval</strong> in
<strong>Activity</strong> instead of acting on its own. Open <strong>Activity</strong> and approve it.</p>
</li>
<li><p><strong>That&#39;s the core loop:</strong> the assistant can read freely, but anything that changes
...
`},{slug:"models",title:"Connect a model",html:`<h1>Connect a model</h1>
...
<h2>Cloud providers (your API keys)</h2>
<p>Open <strong>Settings → Providers</strong> and add a key for any of:</p>
<ul>
...
<h2>Local models (on your machine)</h2>
...
<h2>Embeddings (for Knowledge search)</h2>
...
`},{slug:"features",title:"Using SmartBrain_3000",html:`<h1>Using SmartBrain_3000</h1>
...
and Reindex — see <a href="#models">Embeddings</a>.</p>
</blockquote>
...
`},{slug:"mcp",title:"Connect external tools (MCP)",html:`<h1>Connect external tools (MCP)</h1>
...
`},{slug:"backup-recovery",title:"Backup & recovery",html:`<h1>Backup &amp; recovery</h1>
...
file somewhere safe. Good for reading your data elsewhere or migrating out.</p>
...
recovery and to move your install to a new machine.</p>
<h2>Restore</h2>
...
isn&#39;t safe). Your current database is kept alongside as <code>*.pre-restore</code>, so a
restore is reversible.</p>
<ul>
...
`},{slug:"privacy-security",title:"Privacy & security",html:`<h1>Privacy &amp; security</h1>
...
<h2>What leaves your machine (and when)</h2>
<ul>
...
`},{slug:"remote-access",title:"Remote access (away from home)",html:`<h1>Remote access (away from home)</h1>
...
<p>This needs a small <strong>signaling node</strong> running on a cheap public server (not your home
machine). Your Desktop dials <strong>out</strong> to it, so nothing on your home network is ever
...
remote access may already be configured.</p>
<h2>Pair your phone</h2>
<p><img src="assets/06-remote-access.png" alt="Settings → Remote access: name a phone and pair it"></p>
<p>There are two ways to pair, depending on how you open the app on the phone.</p>
<h3>Option A — Scan a QR code (phone browser / Safari)</h3>
<ol>
<li>On the <strong>Desktop</strong>, open <strong>Settings → Remote access</strong>.</li>
<li>Give the phone a name (e.g. &quot;My phone&quot;) and tap <strong>Pair a new phone</strong>.</li>
<li>On the phone, <strong>scan the QR code with the camera</strong>. It opens the app from the node,
so this works from anywhere with internet.</li>
<li>Tap <strong>Pair this phone</strong> to confirm. You&#39;re connected.</li>
<li>(Recommended) <strong>Add to Home Screen</strong> so you can reopen it with one tap.</li>
</ol>
<p>The QR is shown <strong>once</strong> and carries a one-time credential — close it after pairing.</p>
<h3>Option B — Enter a 6-character code (installed Home-Screen app)</h3>
<p>On iPhone/iPad, an app you&#39;ve <strong>added to the Home Screen</strong> keeps its own storage,
separate from Safari. So the installed app <strong>can&#39;t</strong> inherit a QR you scanned in
Safari — it has to be paired on its own, with a code.</p>
<ol>
<li>Open the <strong>installed (Home Screen) app</strong>. On the pairing screen, it asks for a code.</li>
<li>On the <strong>Desktop</strong>, open <strong>Settings → Remote access</strong>, name the device, and tap
<strong>Pair via code</strong>. A <strong>6-character code</strong> appears.</li>
<li>In the installed app, type that code and tap <strong>Pair</strong>. Do this <strong>within 5 minutes</strong>
and <strong>on the same Wi-Fi as your Desktop</strong>.</li>
</ol>
<blockquote>
<p>In short: Safari and the installed Home-Screen app each pair <strong>once, separately</strong> —
that&#39;s why the code path exists.</p>
</blockquote>
...
<li><strong>One-time credentials.</strong> A QR or code carries a single-use pairing secret — close
the QR after pairing, and don&#39;t share a code.</li>
</ul>
...
<h2>On your own Wi-Fi (LAN, HTTPS)</h2>
...
<h2>Setup for operators (one-time)</h2>
<p>Remote access needs the signaling node and the WebRTC overlay running. If you&#39;re setting
this up yourself:</p>
<ol>
<li><p><strong>Run the signaling node</strong> on a small public server (not your home machine):</p>
<pre><code class="language-sh">SIGNALING_TOKEN=&lt;a-secret&gt;  TURN_USER=&lt;user&gt;  TURN_PASSWORD=&lt;pass&gt; \\
  docker compose -f compose/docker-compose.signaling.yml up -d
</code></pre>
<p>Put a TLS proxy in front so phones can reach it at <code>wss://&lt;your-node-domain&gt;</code>.</p>
</li>
<li><p><strong>Point your Desktop at it</strong> — set these in your environment / <code>.env</code>:</p>
<pre><code class="language-sh">SMARTBRAIN_SIGNALING_URL=wss://&lt;your-node-domain&gt;
...
<li><p><strong>Turn it on:</strong> <code>python3 installer/install.py webrtc up</code> (outbound only — no
port-forward). Turn it off with <code>python3 installer/install.py webrtc down</code>.</p>
</li>
</ol>
<p>Then pair devices as above. (A WireGuard VPN overlay also exists as a CLI-only
alternative — <code>python3 installer/install.py wireguard up</code> — but WebRTC is the
recommended path and needs no router changes.)</p>
<h2>Next</h2>
<ul>
<li><a href="#privacy-security">Privacy &amp; security</a> — what&#39;s protected and the real world limits.</li>
</ul>
`},{slug:"design-limits",title:"Design limits",html:`<h1>Design limits</h1>
...
that.</p>
<h2>Single-user global unlock</h2>
...
<h2>Single-writer embedded database (DuckDB)</h2>
...
<h2>No key at rest (restart returns to locked)</h2>
...
<h2>Append-only audit log (no hash chain)</h2>
...
<h2>Encrypted search is linear (no index pushdown)</h2>
...
<h2>WebRTC signaling broker is single-operator</h2>
<p><a href="#remote-access">Remote access</a> uses a signaling broker that is
<strong>single-operator</strong> by design: devices register with a <strong>shared registration
token</strong>, and the cryptographic guarantee that your phone is really talking to
<strong>your</strong> Desktop is the <strong>DTLS-fingerprint pin</strong> captured at pairing — not the
broker. TURN relay uses <strong>static credentials</strong> bounded by quotas; those
credentials grant <strong>relay bandwidth only</strong>, never access to the app or your
data.</p>
...
`}];var j=I("<a> </a>"),Q=I('<div class="help svelte-1vby5nc"><nav class="help-nav svelte-1vby5nc" aria-label="Help sections"><h2 class="svelte-1vby5nc">Help</h2> <!></nav> <article class="help-body card svelte-1vby5nc"></article></div>');function te(d,y){M(y,!0);const l=G(()=>v.find(e=>e.slug===F.url.hash.replace(/^#/,""))??v[0]);var r=Q(),a=k(r),w=C(k(a),2);H(w,17,()=>v,e=>e.slug,(e,o)=>{var n=j();let t;var p=k(n,!0);u(n),O(()=>{t=Y(n,1,"help-link svelte-1vby5nc",null,t,{active:i(o).slug===i(l).slug}),R(n,"aria-current",i(o).slug===i(l).slug?"page":void 0),R(n,"href",`#${i(o).slug}`),W(p,i(o).title)}),b(e,n)}),u(a);var s=C(a,2);z(s,()=>i(l).html,!0),u(s),u(r),b(d,r),U()}export{te as component};
