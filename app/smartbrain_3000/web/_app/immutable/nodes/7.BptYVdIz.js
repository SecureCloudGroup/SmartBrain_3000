...
`}],C=e(`<li><a> </a></li>`),w=e(`<ul class="help-sub svelte-1vby5nc"></ul>`),T=e(`<a> </a> <!>`,1),E=e(`<div class="help svelte-1vby5nc"><nav class="help-nav svelte-1vby5nc" aria-label="Help sections"><h2 class="svelte-1vby5nc">Help</h2> <!></nav> <article class="help-body card svelte-1vby5nc"></article></div>`);function D(e,D){v(D,!0);let O=u(()=>x.url.hash.replace(/^#/,``).split(`__`)),k=u(()=>S.find(e=>e.slug===o(O)[0])??S[0]),A=u(()=>o(O)[1]),j=p(void 0);d(()=>{if(o(k),typeof window>`u`||!o(j))return;let e=window.matchMedia(`(prefers-reduced-motion: reduce)`);for(let e of o(j).querySelectorAll(`pre`))e.tabIndex=0;let t=()=>{for(let t of o(j).querySelectorAll(`img`)){let n=t.getAttribute(`src`)??``;e.matches&&n.endsWith(`.gif`)?(t.dataset.gif=n,t.setAttribute(`src`,n.replace(/\.gif$/,`.poster.png`))):!e.matches&&t.dataset.gif&&(t.setAttribute(`src`,t.dataset.gif),delete t.dataset.gif)}};return t(),e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)}),d(()=>{o(k);let e=o(A);typeof window>`u`||!o(j)||!e||!/^[\w-]+$/.test(e)||o(j).querySelector(`[id="${e}"]`)?.scrollIntoView()});var M=E(),N=f(M),P=c(f(N),2);b(P,17,()=>S,e=>e.slug,(e,n)=>{var s=T(),u=a(s);let d;var p=f(u,!0);y(u);var h=c(u,2),_=e=>{var i=w();b(i,21,()=>o(n).headings,e=>e.id,(e,i)=>{var a=C(),s=f(a);let c;var u=f(s,!0);y(s),y(a),t(()=>{c=m(s,1,`help-sublink svelte-1vby5nc`,null,c,{active:o(A)===o(i).id}),g(s,`href`,`#${o(n).slug}__${o(i).id}`),r(u,o(i).text)}),l(e,a)}),y(i),t(()=>g(i,`aria-label`,`Sections of ${o(n).title}`)),l(e,i)};i(h,e=>{o(n).slug===o(k).slug&&o(n).headings.length>1&&e(_)}),t(()=>{d=m(u,1,`help-link svelte-1vby5nc`,null,d,{active:o(n).slug===o(k).slug}),g(u,`aria-current`,o(n).slug===o(k).slug?`page`:void 0),g(u,`href`,`#${o(n).slug}`),r(p,o(n).title)}),l(e,s)}),y(N);var F=c(N,2);n(F,()=>o(k).html,!0),y(F),h(F,e=>s(j,e),()=>o(j)),y(M),l(e,M),_()}export{D as component};