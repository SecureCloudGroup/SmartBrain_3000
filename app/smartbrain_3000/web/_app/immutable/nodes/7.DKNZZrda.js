import{A as e,B as t,C as n,D as r,I as i,J as a,K as o,O as s,V as c,W as l,Y as u,Z as d,b as f,c as p,m,nt as h,st as g,tt as _,w as v}from"../chunks/DBeuis-e.js";import"../chunks/xihTtKlq.js";import{t as y}from"../chunks/BcOCCsv9.js";var b=[{slug:`getting-started`,title:`Getting started`,html:`<h1 id="getting-started">Getting started</h1>
...
up for your backend (on the Ollama path the installer and <code>doctor</code> try to do this for
you). See <a href="#models__embeddings-for-knowledge-search">Embeddings</a> for your setup,
then <strong>Reindex</strong> in Knowledge.</li>
...
<p>Removing SmartBrain is two steps, in either order:</p>
<ol>
<li><p><strong>The app + launcher</strong> — however you installed it: <code>brew uninstall --cask smartbrain</code>
(macOS) or <code>scoop uninstall smartbrain</code> (Windows); from source, <code>docker compose down</code>
in <code>compose/</code>.</p>
</li>
<li><p><strong>Your data</strong> — deliberately left behind by step 1 so an uninstall can never destroy
it. When you&#39;re sure (consider <strong>Download encrypted backup</strong> first — see
<a href="#backup-recovery">Backup &amp; recovery</a>):</p>
<pre><code class="language-sh">docker volume rm smartbrain_smartbrain_data smartbrain_bifrost_data
</code></pre>
...
<blockquote>
<p>Semantic search needs an embedding model set up for your backend (the installer does
this for you on the Ollama path). If results say <em>&quot;degraded&quot;</em>, set one up — see
...
reverted change is announced, and <strong>Settings → Self-improvement</strong> shows the complete
record of what it has done.</p>
