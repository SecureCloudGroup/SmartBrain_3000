import{A as e,B as t,C as n,D as r,I as i,J as a,K as o,O as s,V as c,W as l,X as u,Y as d,b as f,c as p,et as m,m as h,ot as g,tt as _,w as v}from"../chunks/c3UmNICx.js";import"../chunks/xihTtKlq.js";import{t as y}from"../chunks/BSzjWF9F.js";var b=[{slug:`getting-started`,title:`Getting started`,html:`<h1 id="getting-started">Getting started</h1>
...
`}],x=e(`<a> </a>`),S=e(`<div class="help svelte-1vby5nc"><nav class="help-nav svelte-1vby5nc" aria-label="Help sections"><h2 class="svelte-1vby5nc">Help</h2> <!></nav> <article class="help-body card svelte-1vby5nc"></article></div>`);function C(e,C){_(C,!0);let w=u(()=>y.url.hash.replace(/^#/,``).split(`__`)),T=u(()=>b.find(e=>e.slug===i(w)[0])??b[0]),E=u(()=>i(w)[1]),D=d(void 0);c(()=>{if(i(T),typeof window>`u`||!i(D))return;let e=window.matchMedia(`(prefers-reduced-motion: reduce)`),t=()=>{for(let t of i(D).querySelectorAll(`img`)){let n=t.getAttribute(`src`)??``;e.matches&&n.endsWith(`.gif`)?(t.dataset.gif=n,t.setAttribute(`src`,n.replace(/\.gif$/,`.poster.png`))):!e.matches&&t.dataset.gif&&(t.setAttribute(`src`,t.dataset.gif),delete t.dataset.gif)}};return t(),e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)}),c(()=>{i(T);let e=i(E);typeof window>`u`||!i(D)||!e||!/^[\w-]+$/.test(e)||i(D).querySelector(`[id="${e}"]`)?.scrollIntoView()});var O=S(),k=l(O);v(o(l(k),2),17,()=>b,e=>e.slug,(e,n)=>{var a=x();let o;var c=l(a,!0);g(a),t(()=>{o=f(a,1,`help-link svelte-1vby5nc`,null,o,{active:i(n).slug===i(T).slug}),h(a,`aria-current`,i(n).slug===i(T).slug?`page`:void 0),h(a,`href`,`#${i(n).slug}`),r(c,i(n).title)}),s(e,a)}),g(k);var A=o(k,2);n(A,()=>i(T).html,!0),g(A),p(A,e=>a(D,e),()=>i(D)),g(O),s(e,O),m()}export{C as component};