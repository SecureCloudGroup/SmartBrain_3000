...
`}],C=h(`<li><a> </a></li>`),w=h(`<ul class="help-sub svelte-1vby5nc"></ul>`),T=h(`<a> </a> <!>`,1),E=h(`<div class="help svelte-1vby5nc"><nav class="help-nav svelte-1vby5nc" aria-label="Help sections"><h2 class="svelte-1vby5nc">Help</h2> <!></nav> <article class="help-body card svelte-1vby5nc"></article></div>`);function D(h,D){m(D,!0);let O=e(()=>x.url.hash.replace(/^#/,``).split(`__`)),k=e(()=>S.find(e=>e.slug===a(O)[0])??S[0]),A=e(()=>a(O)[1]),j=l(void 0);r(()=>{if(a(k),typeof window>`u`||!a(j))return;let e=window.matchMedia(`(prefers-reduced-motion: reduce)`);for(let e of a(j).querySelectorAll(`pre`))e.tabIndex=0;let t=()=>{for(let t of a(j).querySelectorAll(`img`)){let n=t.getAttribute(`src`)??``;e.matches&&n.endsWith(`.gif`)?(t.dataset.gif=n,t.setAttribute(`src`,n.replace(/\.gif$/,`.poster.png`))):!e.matches&&t.dataset.gif&&(t.setAttribute(`src`,t.dataset.gif),delete t.dataset.gif)}};return t(),e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)}),r(()=>{a(k);let e=a(A);typeof window>`u`||!a(j)||!e||!/^[\w-]+$/.test(e)||a(j).querySelector(`[id="${e}"]`)?.scrollIntoView()});var M=E(),N=n(M),P=_(n(N),2);s(P,17,()=>S,e=>e.slug,(e,r)=>{var l=T(),u=i(l);let d;var m=n(u,!0);f(u);var h=_(u,2),v=e=>{var t=w();s(t,21,()=>a(r).headings,e=>e.id,(e,t)=>{var i=C(),s=n(i);let l;var u=n(s,!0);f(s),f(i),c(()=>{l=b(s,1,`help-sublink svelte-1vby5nc`,null,l,{active:a(A)===a(t).id}),p(s,`href`,`#${a(r).slug}__${a(t).id}`),o(u,a(t).text)}),g(e,i)}),f(t),c(()=>p(t,`aria-label`,`Sections of ${a(r).title}`)),g(e,t)};t(h,e=>{a(r).slug===a(k).slug&&a(r).headings.length>1&&e(v)}),c(()=>{d=b(u,1,`help-link svelte-1vby5nc`,null,d,{active:a(r).slug===a(k).slug}),p(u,`aria-current`,a(r).slug===a(k).slug?`page`:void 0),p(u,`href`,`#${a(r).slug}`),o(m,a(r).title)}),g(e,l)}),f(N);var F=_(N,2);y(F,()=>a(k).html,!0),f(F),d(F,e=>u(j,e),()=>a(j)),f(M),g(h,M),v()}export{D as component};