...
`},{slug:`features`,title:`Using SmartBrain_3000`,headings:[{id:`where-things-live`,text:`Where things live`},{id:`chat`,text:`Chat`},{id:`voice`,text:`Voice`},{id:`what-the-assistant-can-do`,text:`What the assistant can do`},{id:`knowledge`,text:`Knowledge`},{id:`planner`,text:`Planner`},{id:`schedules`,text:`Schedules`},{id:`info`,text:`Info`},{id:`email-gmail`,text:`Email (Gmail)`},{id:`memory`,text:`Memory`},{id:`web-search`,text:`Web search`},{id:`self-improvement`,text:`Self-improvement`},{id:`usage-cost`,text:`Usage & cost`},{id:`activity`,text:`Activity`},{id:`settings`,text:`Settings`},{id:`next`,text:`Next`}],html:`<h1 id="using-smartbrain_3000">Using SmartBrain_3000</h1>
