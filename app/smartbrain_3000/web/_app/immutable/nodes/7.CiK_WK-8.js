...
<ol>
<li><strong>You pick the source.</strong> The assistant can suggest where the data could come
...
change it later without asking you again.</li>
...
minute is the floor), never in real time.</p>
...
`},{slug:`mcp`,title:`Connect external tools (MCP)`,headings:[{id:`turn-it-on`,text:`Turn it on`},{id:`point-a-tool-at-it`,text:`Point a tool at it`},{id:`what-it-can-and-cant-do`,text:`What it can and can't do`},{id:`next`,text:`Next`}],html:`<h1 id="connect-external-tools-mcp">Connect external tools (MCP)</h1>
