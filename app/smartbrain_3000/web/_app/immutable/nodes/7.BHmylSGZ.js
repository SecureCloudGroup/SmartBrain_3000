...
and local self-repair run on a local model or not at all.)</li>
...
`}],w=g(`<li><a> </a></li>`),T=g(`<ul class="help-sub svelte-1vby5nc"></ul>`),E=g(`<a> </a> <!>`,1),D=g(`<div class="help svelte-1vby5nc"><nav class="help-nav svelte-1vby5nc" aria-label="Help sections"><h2 class="svelte-1vby5nc">Help</h2> <!></nav> <article class="help-body card svelte-1vby5nc"></article></div>`);function O(g,O){d(O,!0);let k=p(()=>S.url.hash.replace(/^#/,``).split(`__`)),A=p(()=>C.find(e=>e.slug===a(k)[0])??C[0]),j=p(()=>a(k)[1]),M=u(void 0);n(()=>{if(a(A),typeof window>`u`||!a(M))return;let e=window.matchMedia(`(prefers-reduced-motion: reduce)`);for(let e of a(M).querySelectorAll(`pre`))e.tabIndex=0;let t=()=>{for(let t of a(M).querySelectorAll(`img`)){let n=t.getAttribute(`src`)??``;e.matches&&n.endsWith(`.gif`)?(t.dataset.gif=n,t.setAttribute(`src`,n.replace(/\.gif$/,`.poster.png`))):!e.matches&&t.dataset.gif&&(t.setAttribute(`src`,t.dataset.gif),delete t.dataset.gif)}};return t(),e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)}),n(()=>{a(A);let e=a(j);typeof window>`u`||!a(M)||!e||!/^[\w-]+$/.test(e)||a(M).querySelector(`[id="${e}"]`)?.scrollIntoView()});var N=D(),P=t(N),F=r(t(P),2);s(F,17,()=>C,e=>e.slug,(n,l)=>{var u=E(),d=i(u);let f;var p=y(d,!0),h=r(d,2),g=e=>{var n=T();s(n,21,()=>a(l).headings,e=>e.id,(e,n)=>{var r=w(),i=t(r);let s;var u=y(i,!0);v(r),c(()=>{s=x(i,1,`help-sublink svelte-1vby5nc`,null,s,{active:a(j)===a(n).id}),m(i,`href`,`#${a(l).slug}__${a(n).id}`),o(u,a(n).text)}),_(e,r)}),v(n),c(()=>m(n,`aria-label`,`Sections of ${a(l).title}`)),_(e,n)};e(h,e=>{a(l).slug===a(A).slug&&a(l).headings.length>1&&e(g)}),c(()=>{f=x(d,1,`help-link svelte-1vby5nc`,null,f,{active:a(l).slug===a(A).slug}),m(d,`aria-current`,a(l).slug===a(A).slug?`page`:void 0),m(d,`href`,`#${a(l).slug}`),o(p,a(l).title)}),_(n,u)}),v(P);var I=r(P,2);b(I,()=>a(A).html,!0),v(I),f(I,e=>l(M,e),()=>a(M)),v(N),_(g,N),h()}export{O as component};