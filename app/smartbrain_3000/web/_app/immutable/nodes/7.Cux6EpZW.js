import{$ as e,C as t,D as n,E as r,G as i,J as a,P as o,Q as s,R as c,S as l,U as u,Y as d,c as f,it as p,k as m,p as h,q as g,y as _,z as v}from"../chunks/9DS1GQYk.js";import"../chunks/xihTtKlq.js";import{t as y}from"../chunks/BybfEF3H.js";var b=[{slug:`getting-started`,title:`Getting started`,html:`<h1 id="getting-started">Getting started</h1>
...
<ul>
<li><strong>Homebrew (macOS):</strong> <code>brew upgrade --cask smartbrain</code>, then reopen the app.</li>
...
<p>Your data lives in a folder on your machine and is left untouched by an update. (More on
...
Docker Desktop (or <code>colima start</code>), then reopen the app (or re-run the command).</li>
...
downloading the image), then try again. Still stuck? Check the logs: <code>docker compose -f docker-compose.release.yml logs smartbrain</code> (from source, use <code>compose/docker-compose.yml</code>).</li>
...
Excel (.xlsx), HTML and text files</strong> — a whole folder at once if you like — paste a URL,
