...
def test_migration_23_preserves_membership_rows(tmp_path) -> None:
    ...
    assert dbmod.run_migrations(conn) == 17  # 23 + doc_summaries (24) + chat trash (25) + embed total (26) + selfimprove (27-35) + import traces (36) + UTC shift (37) + feeds (38) + usage cost (39)
    row = conn.execute(
